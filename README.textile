...
* Install MySQL if you don't have it already. http://hivelogic.com/articles/installing-mysql-on-mac-os-x/
* Install the latest version of Ruby, RoR, MySQL, Git, etc. http://hivelogic.com/articles/ruby-rails-leopard
...
* ./script/server
* Go to http://localhost:3000 or http://localhost:3000/admin
